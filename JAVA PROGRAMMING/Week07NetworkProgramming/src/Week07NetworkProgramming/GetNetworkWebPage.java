 ...
 *
 * Demonstrates Java reflection to interrogate the RentCabin class
...
public class RentCabinReflection {
    ...
    public static void main(String[] args) {
        try {
            ...
            // 13) Access a private field (here, "squareFeet")
            Field squareFeetField = cabinClass.getDeclaredField("squareFeet");
            ...
            // 15) Print the field value of squareFeet from the rentCabinInstance
            Object squareFeetValue = squareFeetField.get(rentCabinInstance);
            System.out.println("15) Private field 'squareFeet' value: " + squareFeetValue);
