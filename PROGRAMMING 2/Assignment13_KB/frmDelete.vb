Public Class frmDelete
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        Try
            ...
            result = MessageBox.Show("Are you sure you want to Delete Student: " & cboPassengers.Text & "?", "Confirm Deletion", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question)
            ...
            Select Case result
                ...
                Case DialogResult.Yes
                    ...
                    strDelete = "Delete FROM TPassengers Where intPassengerID = " & cboPassengers.SelectedValue.ToString
