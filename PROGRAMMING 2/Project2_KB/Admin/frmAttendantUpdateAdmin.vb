Public Class frmAttendantUpdateAdmin
    Private Sub frmAttendantUpdateAdmin_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            ' Load attendants into the combo box
            LoadAttendantSelection()
    ...
    Private Sub LoadAttendantSelection()
        ...
        Try
            ...
            ' Bind the ComboBox
            cboAttendantSelection.ValueMember = "intAttendantID"
            cboAttendantSelection.DisplayMember = "FullName"
            cboAttendantSelection.DataSource = dt
    ...
    Private Sub cboAttendantSelection_SelectedIndexChanged(sender As Object, e As EventArgs) Handles cboAttendantSelection.SelectedIndexChanged
        If cboAttendantSelection.SelectedValue IsNot Nothing Then
            intAttendant = CInt(cboAttendantSelection.SelectedValue)
            LoadAttendantData()
        End If
    End Sub
    ...
    Private Sub LoadAttendantData()
        ...
        Try
            ...
            ' Initialize command with connection and query
            cmdSelect = New OleDb.OleDbCommand(strSelect, m_conAdministrator)
