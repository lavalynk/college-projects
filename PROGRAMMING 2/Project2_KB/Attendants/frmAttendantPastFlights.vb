    ...
    Private Sub frmAttendantPastFlights_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            strSelect = "SELECT TF.intFlightID, TF.strFlightNumber, TF.dtmFlightDate, TF.dtmTimeofDeparture, TF.dtmTimeOfLanding, " &
                        "FA.strAirportCode AS strFromAirportCode, TAIR.strAirportCode AS strToAirportCode, TF.intMilesFlown, " &
                        ...
                        "FA.strAirportCode, TAIR.strAirportCode, TF.intMilesFlown, TPlanes.strPlaneNumber, TPlaneTypes.strPlaneType"
